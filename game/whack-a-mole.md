...
340 WAIT 12:IF I2CW(62,#701,1,#702,1)+I2CW(62,#700,1,#900,16)+I2CW(62,#701,1,#703,1)+I2CW(62,#700,1,#920,16)?"E" ELSE RETURN
```
...
190 LED0:LRUN 0
300 WAIT 10
310 IF I2CW(62,#701,1,#702,1)+I2CW(62,#700,1,#900,16)+I2CW(62,#701,1,#703,1)+I2CW(62,#700,1,#920,16)?"E" ELSE RETURN
320 IF I2CW(98,#711,1,#715,1)+I2CW(98,#712,1,#715,1)+I2CW(98,#713,1,#714,1)?"E" ELSE RETURN
330 IF I2CW(98,#711,1,#715,1)+I2CW(98,#712,1,#714,1)+I2CW(98,#713,1,#715,1)?"E" ELSE RETURN
340 IF I2CW(98,#711,1,#714,1)+I2CW(98,#712,1,#715,1)+I2CW(98,#713,1,#715,1)?"E" ELSE RETURN
```
